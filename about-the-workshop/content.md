...
- **Lab 1 :** Upgrade using the new AutoUpgrade tool
...
- **Lab 2 :** Upgrade using Full Transportable Tablespaces
...
- **Lab 3 :** Upgrade using unplugging a PDB from the old version and plug it into a new version
...
- **Lab 4 :** Upgrade to 19c on Oracle Autonomous Database cloud using MV2ADB
